"""
Avengercon IX workshop: Python Data Engineering Automation
"""
...
# Use the MINIO_ENDPOINT environment variable as a canary for whether the broader
# corpus of required environment variables are currently set.
if not getenv("MINIO_ENDPOINT"):
